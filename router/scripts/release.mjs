...
/**用于终端输出添加着色，可以使输出文本具有不同的颜色 */
import chalk from 'chalk'
/**用于处理语义化版本号的库，提供了比较、解析和操作版本号的功能 */
import semver from 'semver'
/**交互式命令行提示库，用于创建各种类型的用户输入界面 */
import enquirer from 'enquirer'
/**简化 Node.js 子进程的库，提供更简单的 API 以执行外部命令 */
import { execa } from 'execa'
/**用于按顺序执行异步函数的库，确保每个函数在上一个函数完成后才会执行 */
import pSeries from 'p-series'
/**用于匹配文件路径的库，支持使用通配符进行模式匹配 */
